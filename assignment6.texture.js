...
class Texture {
    ...
    createTexture( gl, flip_y ) {
        ...
        image.onload = () => {
            ...
            gl.bindTexture(gl.TEXTURE_2D, texture); // bind texture to webgl
            gl.texImage2D(gl.TEXTURE_2D, level, internal_format, src_format, src_type, image) // upload image data to texture
